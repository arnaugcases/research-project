...
function observationError(AircraftDatabase.AircraftStateOccurrences[] memory observations, AircraftDatabase.AircraftStateVector memory trueValue, int errorAllowed) public  pure returns(int[] memory){
...
function position_prediction(int24 _delta_time, AircraftDatabase.AircraftStateVector memory previous_estimate)  returns(int24[] memory){
